...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    ...
    const fetchKountConfig = async () => {
      ...
      try {
        ...
        setKountConfigError(error instanceof Error ? error.message : 'Failed to fetch fraud detection configuration');
      } finally {
  ...
  return (
    <div className="px-4 md:px-6 md:py-16 py-8 lg:max-w-7xl mx-auto lg:py-24">
