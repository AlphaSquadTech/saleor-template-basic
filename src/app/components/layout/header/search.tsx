...
const Search = ({ className }: { className?: string }) => {
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "flex items-center relative max-w-140 bg-white/10 px-4 py-2.5 max-h-10 justify-between w-full",
        className
      )}
    >
      <form
      ...
      >
        <InputField
          className="leading-none w-full px-0 py-0 placeholder:text-white!"
          name="Search-product"
          type="text"
          placeholder="Search by Vehicle, Keyword, or Part Number"
          value={term}
